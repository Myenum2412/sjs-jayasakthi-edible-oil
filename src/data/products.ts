...
const data: Product[] = [
  ...
  },
  {
    ...
    price: "₹4.99",
    originalPrice: "₹6.99",
    image: encodeImagePath("/products/aurn-gold-1liter/aurn-gold-1liter.png"),
    imageSecondary: encodeImagePath("/products/aurn-gold-1liter/aurn-gold-1liter-theme.png"),
    imageGallery: [
      encodeImagePath("/products/aurn-gold-1liter/aurn-gold-1liter.png"),
      encodeImagePath("/products/aurn-gold-1liter/aurn-gold-1liter-theme.png"),
    ],
    description:
  ...
  },
  {
    ...
    price: "₹8.99",
    originalPrice: "₹10.99",
    image: encodeImagePath("/products/three-roses-1liter/three-roses-1liter.png"),
    imageSecondary: encodeImagePath("/products/three-roses-1liter/three-roses-1liter-theme.png"),
    imageGallery: [
      encodeImagePath("/products/three-roses-1liter/three-roses-1liter.png"),
      encodeImagePath("/products/three-roses-1liter/three-roses-1liter-theme.png"),
    ],
    description:
  ...
  },
  {
    ...
    image: encodeImagePath("/products/sir-Gold-1liter/sir-gold-1liter.png"),
    imageSecondary: encodeImagePath("/products/sir-Gold-1liter/sir-gold-1liter-theme.png"),
    imageGallery: [
      encodeImagePath("/products/sir-Gold-1liter/sir-gold-1liter.png"),
      encodeImagePath("/products/sir-Gold-1liter/sir-gold-1liter-theme.png"),
    ],
    description:
  ...
  },
  {
    ...
    image: encodeImagePath("/products/aurn-1ml-pouch/aurn-1ml-pouch.png"),
    imageSecondary: encodeImagePath("/products/aurn-1ml-pouch/aurn-1ml-pouch-theme.png"),
    imageGallery: [
      encodeImagePath("/products/aurn-1ml-pouch/aurn-1ml-pouch.png"),
      encodeImagePath("/products/aurn-1ml-pouch/aurn-1ml-pouch-theme.png"),
    ],
  ...
  },
  {
    ...
    price: "₹75.00",
    originalPrice: "₹85.00",
    image: encodeImagePath("/products/aurn-500ml-pouch/aurn-500ml-pouch.png"),
    imageSecondary: encodeImagePath("/products/aurn-500ml-pouch/aurn-500ml-pouch-theme.png"),
    imageGallery: [
      encodeImagePath("/products/aurn-500ml-pouch/aurn-500ml-pouch.png"),
      encodeImagePath("/products/aurn-500ml-pouch/aurn-500ml-pouch-theme.png"),
    ],
