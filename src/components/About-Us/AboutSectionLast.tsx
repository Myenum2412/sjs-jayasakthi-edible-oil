...
export default function AboutSectionLast() {
    ...
    >
      ...
      <div className="relative z-10 max-w-2xl mx-auto">
        ...
        <TimelineContent
          ...
          customVariants={revealVariants3}
          timelineRef={heroRef}
          className="bg-primary hover:bg-primary/80 shadow-lg shadow-primary border border-primary flex w-fit mx-auto gap-2 hover:gap-4 transition-all duration-300 ease-in-out text-white px-5 py-3 rounded-full cursor-pointer"
        >
          Explore Our Products <ArrowRight className="" />
        </TimelineContent>
      </div>
