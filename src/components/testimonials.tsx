  ...
  return (
    <section className="w-full bg-background py-16 sm:py-24">
      <div className="container mx-auto max-w-6xl px-4 text-center">
        {/* Section Header */}
        <h2 className="text-3xl md:text-5xl tracking-tighter max-w-xl font-regular text-center mx-auto">
          {title}
        </h2>
        <p className="text-lg md:text-xl tracking-tighter max-w-xl font-regular text-center mx-auto my-5">
          {subtitle}
        </p>
